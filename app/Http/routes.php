...
Route::get('/goods/{id}','GoodsController@show')->name('good');
...
Route::post('/order/{id}','OrderController@newOrder');
...
Route::get('admin/goods/show/{good}','Admin\GoodsController@show');
...
///
Route::get('/admin/goods/edit/{good}','Admin\GoodsController@edit');
///
